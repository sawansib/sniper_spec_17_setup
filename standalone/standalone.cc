...
int main(int argc, char *argv[]) {
  ...
  LOG_ASSERT_ERROR(Sim()->getTraceManager(),
                   "In standalone mode but there is no TraceManager!");
  Sim()->getTraceManager()->run();
  // Iterate over a number of application runs. This can allow for a warmup pass
