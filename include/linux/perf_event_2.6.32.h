...
static __inline__ __u16 __fswab16(__u16 val) { return ___constant_swab16(val); }

static __inline__ __u32 __fswab32(__u32 val) { return __arch_swab32(val); }

static __inline__ __u64 __fswab64(__u64 val) { return __arch_swab64(val); }
 ...
 */
static __inline__ __u16 __swab16p(const __u16 *p) { return __swab16(*p); }

/**
 * __swab32p - return a byteswapped 32-bit value from a pointer
 * @p: pointer to a naturally-aligned 32-bit value
 */
static __inline__ __u32 __swab32p(const __u32 *p) { return __swab32(*p); }

/**
 * __swab64p - return a byteswapped 64-bit value from a pointer
 * @p: pointer to a naturally-aligned 64-bit value
 */
static __inline__ __u64 __swab64p(const __u64 *p) { return __swab64(*p); }
 ...
 */
static __inline__ __u32 __swahw32p(const __u32 *p) { return __swahw32(*p); }
 ...
 */
static __inline__ __u32 __swahb32p(const __u32 *p) { return __swahb32(*p); }

/**
 * __swab16s - byteswap a 16-bit value in-place
 * @p: pointer to a naturally-aligned 16-bit value
 */
static __inline__ void __swab16s(__u16 *p) { *p = __swab16p(p); }
/**
 * __swab32s - byteswap a 32-bit value in-place
 * @p: pointer to a naturally-aligned 32-bit value
 */
static __inline__ void __swab32s(__u32 *p) { *p = __swab32p(p); }

/**
 * __swab64s - byteswap a 64-bit value in-place
 * @p: pointer to a naturally-aligned 64-bit value
 */
static __inline__ void __swab64s(__u64 *p) { *p = __swab64p(p); }
 ...
 * See __swahw32() for details of wordswapping
 */
static __inline__ void __swahw32s(__u32 *p) { *p = __swahw32p(p); }
 ...
 */
static __inline__ void __swahb32s(__u32 *p) { *p = __swahb32p(p); }
...
static __inline__ __le64 __cpu_to_le64p(const __u64 *p) { return (__le64)*p; }
static __inline__ __u64 __le64_to_cpup(const __le64 *p) { return (__u64)*p; }
static __inline__ __le32 __cpu_to_le32p(const __u32 *p) { return (__le32)*p; }
static __inline__ __u32 __le32_to_cpup(const __le32 *p) { return (__u32)*p; }
static __inline__ __le16 __cpu_to_le16p(const __u16 *p) { return (__le16)*p; }
static __inline__ __u16 __le16_to_cpup(const __le16 *p) { return (__u16)*p; }
