...
PthreadLock::PthreadLock() { pthread_mutex_init(&_mutx, NULL); }

PthreadLock::~PthreadLock() { pthread_mutex_destroy(&_mutx); }

void PthreadLock::acquire() { pthread_mutex_lock(&_mutx); }

void PthreadLock::release() { pthread_mutex_unlock(&_mutx); }
