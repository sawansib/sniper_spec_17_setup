...
class Config {
 public:
  ...
  // Get CoreId length
  UInt32 getCoreIDLength() { return m_core_id_length; }

  SimulationMode getSimulationMode() { return m_simulation_mode; }
  ...
  bool getIssueMemopsAtFunctional() const {
    return m_knob_issue_memops_at_functional;
  }
  ...
  ClockSkewMinimizationObject::Scheme getClockSkewMinimizationScheme() const {
    return m_knob_clock_skew_minimization_scheme;
  }
  ...
  bool getEnableSpinLoopDetection() const {
    return m_knob_enable_spinloopdetection;
  }
  ...
  bool getEnableSyscallEmulation() const {
    return m_knob_enable_syscall_emulation;
  }
  ...
  const CacheEfficiencyTracker::Callbacks &getCacheEfficiencyCallbacks() const {
    return m_cache_efficiency_callbacks;
  }
  bool hasCacheEfficiencyCallbacks() const {
    return m_cache_efficiency_callbacks.notify_evict_func != NULL;
  }
  void setCacheEfficiencyCallbacks(
 ...
 private:
  ...
  static ClockSkewMinimizationObject::Scheme
