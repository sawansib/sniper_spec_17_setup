...
// Tags
//
//   An object (String) can have a number of tags (String) associated with it.
//   Additionally, each tag can be assigned
// a value (UInt64). The goal of this tagging system is to allow for informal
// communication between different components. Initial tags are set via init()
