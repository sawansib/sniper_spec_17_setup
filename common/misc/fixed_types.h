...
// But if someone else already included stdint.h without first defining
// __STDC_LIMIT_MACROS, UINT64_MAX and friends will not be defined. Test for
// this here.
#ifndef UINT64_MAX
#error \
    "UINT64_MAX is not defined. Make sure fixed_types.h is first in the include order."
#endif
#ifndef PRId64
#error \
    "PRId64 is not defined. Make sure fixed_types.h is first in the include order."
#endif
