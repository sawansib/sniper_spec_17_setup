...
class MemoryManagerFast : public MemoryManagerBase {
 ...
 public:
  MemoryManagerFast(Core* core, Network* network,
  ...
  HitWhere::where_t coreInitiateMemoryAccess(
    ...
    SubsecondTime latency = coreInitiateMemoryAccessFast(
        mem_component == MemComponent::L1_ICACHE ? true : false, mem_op_type,
        address);
