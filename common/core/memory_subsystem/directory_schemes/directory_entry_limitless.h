...
class DirectoryEntryLimitless : public DirectoryEntrySized<DirectorySharers> {
 ...
 public:
  DirectoryEntryLimitless(UInt32 max_hw_sharers, UInt32 max_num_sharers,
...
DirectoryEntryLimitless<DirectorySharers>::DirectoryEntryLimitless(
    UInt32 max_hw_sharers, UInt32 max_num_sharers,
    SubsecondTime software_trap_penalty)
...
template <class DirectorySharers>
SubsecondTime DirectoryEntryLimitless<DirectorySharers>::getLatency() {
...
template <class DirectorySharers>
bool DirectoryEntryLimitless<DirectorySharers>::hasSharer(core_id_t sharer_id) {
...
template <class DirectorySharers>
core_id_t DirectoryEntryLimitless<DirectorySharers>::getOwner() {
  return this->m_owner_id;
}

template <class DirectorySharers>
void DirectoryEntryLimitless<DirectorySharers>::setOwner(core_id_t owner_id) {
  if (owner_id != INVALID_CORE_ID) assert(this->m_sharers[owner_id]);
  this->m_owner_id = owner_id;
}

template <class DirectorySharers>
core_id_t DirectoryEntryLimitless<DirectorySharers>::getOneSharer() {
