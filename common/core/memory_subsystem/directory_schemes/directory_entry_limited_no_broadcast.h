...
class DirectoryEntryLimitedNoBroadcast
    : public DirectoryEntrySized<DirectorySharers> {
 public:
  DirectoryEntryLimitedNoBroadcast(UInt32 max_hw_sharers,
...
template <class DirectorySharers>
DirectoryEntryLimitedNoBroadcast<
    DirectorySharers>::DirectoryEntryLimitedNoBroadcast(UInt32 max_hw_sharers,
                                                        UInt32 max_num_sharers)
    : DirectoryEntrySized<DirectorySharers>(max_hw_sharers, max_num_sharers) {}

template <class DirectorySharers>
DirectoryEntryLimitedNoBroadcast<
    DirectorySharers>::~DirectoryEntryLimitedNoBroadcast() {}
...
bool DirectoryEntryLimitedNoBroadcast<DirectorySharers>::addSharer(
    core_id_t sharer_id, UInt32 max_hw_sharers) {
...
void DirectoryEntryLimitedNoBroadcast<DirectorySharers>::removeSharer(
    core_id_t sharer_id, bool reply_expected) {
...
template <class DirectorySharers>
core_id_t DirectoryEntryLimitedNoBroadcast<DirectorySharers>::getOwner() {
...
void DirectoryEntryLimitedNoBroadcast<DirectorySharers>::setOwner(
    core_id_t owner_id) {
  if (owner_id != INVALID_CORE_ID) assert(this->m_sharers[owner_id]);
  this->m_owner_id = owner_id;
}

template <class DirectorySharers>
core_id_t DirectoryEntryLimitedNoBroadcast<DirectorySharers>::getOneSharer() {
...
template <class DirectorySharers>
SubsecondTime DirectoryEntryLimitedNoBroadcast<DirectorySharers>::getLatency() {
