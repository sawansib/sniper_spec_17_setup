...
class MemoryManagerBase {
 ...
 private:
  ...
  void parseMemoryControllerList(
 ...
 protected:
  ...
  void printCoreListWithMemoryControllers(
 ...
 public:
  ...
  virtual HitWhere::where_t coreInitiateMemoryAccess(
      ...
      UInt32 data_length, Core::MemModeled modeled) = 0;
  virtual SubsecondTime coreInitiateMemoryAccessFast(bool icache,
                                                     Core::mem_op_t mem_op_type,
                                                     IntPtr address) {
    // Emulate fast interface by calling into slow interface
    SubsecondTime initial_time =
    ...
    coreInitiateMemoryAccess(
        icache ? MemComponent::L1_ICACHE : MemComponent::L1_DCACHE, Core::NONE,
        mem_op_type, address - (address % getCacheBlockSize()), 0, NULL,
        getCacheBlockSize(), Core::MEM_MODELED_COUNT_TLBTIME);
  ...
  virtual void addL1Hits(bool icache, Core::mem_op_t mem_op_type,
                         UInt64 hits) = 0;
  ...
  virtual void sendMsg(PrL1PrL2DramDirectoryMSI::ShmemMsg::msg_t msg_type,
                       ...
                       ShmemPerfModel::Thread_t thread_num =
                           ShmemPerfModel::NUM_CORE_THREADS) = 0;
  ...
  static MemoryManagerBase* createMMU(String protocol_type, Core* core,
                                      Network* network,
                                      ShmemPerfModel* shmem_perf_model);
};
