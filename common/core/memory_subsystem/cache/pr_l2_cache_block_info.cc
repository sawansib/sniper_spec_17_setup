...
MemComponent::component_t PrL2CacheBlockInfo::getCachedLoc() {
  LOG_ASSERT_ERROR(m_cached_loc_bitvec != ((1 << MemComponent::L1_ICACHE) |
                                           (1 << MemComponent::L1_DCACHE)),
...
void PrL2CacheBlockInfo::setCachedLoc(MemComponent::component_t cached_loc) {
...
void PrL2CacheBlockInfo::clearCachedLoc(MemComponent::component_t cached_loc) {
  LOG_ASSERT_ERROR(cached_loc != MemComponent::INVALID_MEM_COMPONENT,
                   "m_cached_loc_bitvec(%u), cached_loc(%u)",
                   m_cached_loc_bitvec, cached_loc);
  LOG_ASSERT_ERROR(m_cached_loc_bitvec & (1 << cached_loc),
...
void PrL2CacheBlockInfo::clone(CacheBlockInfo* cache_block_info) {
  m_cached_loc_bitvec =
      ((PrL2CacheBlockInfo*)cache_block_info)->getCachedLocBitVec();
