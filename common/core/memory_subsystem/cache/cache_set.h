...
// can collect data from all CacheSet* objects which are per set and implement
// the actual replacement policy
class CacheSetInfo {
 public:
...
class CacheSet {
 public:
  static CacheSet* createCacheSet(String cfgname, core_id_t core_id,
                                  ...
                                  CacheSetInfo* set_info = NULL);
  static CacheSetInfo* createCacheSetInfo(String name, String cfgname,
                                          core_id_t core_id,
                                          String replacement_policy,
 ...
 public:
  ...
  CacheBlockInfo* peekBlock(UInt32 way) const {
    return m_cache_block_info_array[way];
  }
