...
// From
// http://stackoverflow.com/questions/8027368/are-there-no-specializations-of-stdhash-for-standard-containers
namespace std {
template <typename T>
 ...
 public:
  class Routine {
   public:
    ...
    void updateLocation(const char *name, const char *imgname, IntPtr offset,
                        int column, int line, const char *filename);
  };
