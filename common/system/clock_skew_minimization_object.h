...
class ClockSkewMinimizationClient : public ClockSkewMinimizationObject {
 ...
 public:
  ...
  virtual void synchronize(SubsecondTime time = SubsecondTime::Zero(),
                           bool ignore_time = false,
                           bool abort_func(void*) = NULL,
                           void* abort_arg = NULL) = 0;
};
...
class ClockSkewMinimizationServer : public ClockSkewMinimizationObject {
 ...
 public:
  ...
  virtual void setFastForward(
      bool fastforward,
      SubsecondTime next_barrier_time = SubsecondTime::MaxTime()) = 0;
