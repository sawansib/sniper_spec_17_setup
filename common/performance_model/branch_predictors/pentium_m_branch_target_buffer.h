...
#define IP_TO_TAGOFF(_ip) (_ip & TAG_OFFSET_MASK)
  ...
  class Way {
   public:
    Way() : m_tag_offset(NUM_ENTRIES, 0), m_plru(NUM_ENTRIES, 0) {}
 ...
 public:
  PentiumMBranchTargetBuffer() : m_ways(NUM_WAYS), m_lru_use_count(0) {}

  bool predict(IntPtr ip, IntPtr target) { return false; }
  ...
  BranchPredictorReturnValue lookup(IntPtr ip, IntPtr target) {
    ...
    BranchPredictorReturnValue ret = {
        false, hit, 0, BranchPredictorReturnValue::InvalidBranch};
