...
class IntervalContention {
 public:
  static IntervalContention *createIntervalContentionModel(
      Core *core, const CoreModel *core_model);
  ...
  virtual uint64_t getEffectiveCriticalPathLength(uint64_t critical_path_length,
                                                  bool update_reason) = 0;
};
