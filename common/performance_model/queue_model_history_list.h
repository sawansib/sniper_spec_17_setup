...
class QueueModelHistoryList : public QueueModel {
 public:
  ...
  QueueModelHistoryList(String name, UInt32 id,
                        SubsecondTime min_processing_time);
  ~QueueModelHistoryList();

  SubsecondTime computeQueueDelay(SubsecondTime pkt_time,
 ...
 private:
  ...
  SubsecondTime computeUsingHistoryList(SubsecondTime pkt_time,
                                        SubsecondTime processing_time);
  SubsecondTime computeUsingAnalyticalModel(SubsecondTime pkt_time,
                                            SubsecondTime processing_time);
};
