...
class parserError : public std::exception {
 public:
  ...
  virtual const char* what() const throw() { return m_leftover.c_str(); }
...
class FileNotFound : public std::exception {
 public:
  ...
  virtual const char* what() const throw() { return m_filename.c_str(); }
...
class SaveError : public std::exception {
 public:
  SaveError(const String& error_str) : m_error("Save Error: " + error_str) {}
