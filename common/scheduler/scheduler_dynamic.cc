...
SchedulerDynamic::SchedulerDynamic(ThreadManager *thread_manager)
    : Scheduler(thread_manager), m_threads_runnable(16), m_in_periodic(false) {
...
void SchedulerDynamic::__threadStart(thread_id_t thread_id,
                                     SubsecondTime time) {
...
void SchedulerDynamic::__threadStall(thread_id_t thread_id,
...
void SchedulerDynamic::__threadResume(thread_id_t thread_id,
...
void SchedulerDynamic::moveThread(thread_id_t thread_id, core_id_t core_id,
                                  SubsecondTime time) {
#if 0
