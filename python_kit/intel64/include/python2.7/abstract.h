...
PyAPI_FUNC(int) PyObject_AsCharBuffer(PyObject *obj, const char **buffer,
...
PyAPI_FUNC(int) PyObject_AsReadBuffer(PyObject *obj, const void **buffer,
                                      Py_ssize_t *buffer_len);
...
PyAPI_FUNC(int) PyObject_AsWriteBuffer(PyObject *obj, void **buffer,
                                       Py_ssize_t *buffer_len);
...
PyAPI_FUNC(PyObject *) _PyNumber_ConvertIntegralToInt(PyObject *integral,
