...
PyAPI_FUNC(PyObject *)
    PyUnicode_FromStringAndSize(const char *u,  /* char buffer */
                                Py_ssize_t size /* size of buffer */
    );
...
PyAPI_FUNC(PyObject *)
    PyUnicode_FromEncodedObject(register PyObject *obj, /* Object */
...
PyAPI_FUNC(PyObject *)
    _PyUnicode_FormatAdvanced(PyObject *obj, Py_UNICODE *format_spec,
...
PyAPI_FUNC(PyObject *)
    PyUnicode_FromWideChar(register const wchar_t *w, /* wchar_t buffer */
                           Py_ssize_t size            /* size of buffer */
    );
...
PyAPI_FUNC(Py_ssize_t)
    PyUnicode_AsWideChar(PyUnicodeObject *unicode, /* Unicode object */
