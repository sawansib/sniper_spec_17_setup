...
stmt_ty _Py_Assign(asdl_seq *targets, expr_ty value, int lineno, int col_offset,
                   PyArena *arena);
...
stmt_ty _Py_Print(expr_ty dest, asdl_seq *values, bool nl, int lineno,
                  int col_offset, PyArena *arena);
...
stmt_ty _Py_Raise(expr_ty type, expr_ty inst, expr_ty tback, int lineno,
                  int col_offset, PyArena *arena);
...
stmt_ty _Py_TryFinally(asdl_seq *body, asdl_seq *finalbody, int lineno,
                       int col_offset, PyArena *arena);
...
stmt_ty _Py_Exec(expr_ty body, expr_ty globals, expr_ty locals, int lineno,
                 int col_offset, PyArena *arena);
...
expr_ty _Py_Call(expr_ty func, asdl_seq *args, asdl_seq *keywords,
                 expr_ty starargs, expr_ty kwargs, int lineno, int col_offset,
                 PyArena *arena);
...
expr_ty _Py_Subscript(expr_ty value, slice_ty slice, expr_context_ty ctx,
                      int lineno, int col_offset, PyArena *arena);
...
arguments_ty _Py_arguments(asdl_seq *args, identifier vararg, identifier kwarg,
