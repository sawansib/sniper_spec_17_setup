...
class InstructionModeling {
 public:
  static VOID addInstructionModeling(TRACE trace, INS ins,
  ...
  static VOID countInstructions(THREADID threadid, ADDRINT address,
                                INT32 count);
  static VOID accessInstructionCacheWarmup(THREADID threadid, ADDRINT address,
                                           UINT32 size);
};
