	 ...
	 INSTRUMENT_PREDICATED(
       ...
       if (INS_IsCall(ins)) {
       	 if (INS_IsDirectBranchOrCall(ins)) {
       	   INSTRUMENT_PREDICATED(
       	     INSTR_IF_DETAILED(inst_mode),
       	     trace, ins, IPOINT_TAKEN_BRANCH, (AFUNPTR)handleCallDirect, 
       	     IARG_THREAD_ID,
       	     IARG_BRANCH_TARGET_ADDR,
       	     IARG_END);
       	 } else {
       	   INSTRUMENT_PREDICATED(
       	     INSTR_IF_DETAILED(inst_mode),
       	     trace, ins, IPOINT_TAKEN_BRANCH, (AFUNPTR)handleCallIndirect, 
       	     IARG_THREAD_ID,
       	     IARG_BRANCH_TARGET_ADDR,
       	     IARG_END);	   
       	 }
       	 ...
       	 if (INS_IsDirectBranchOrCall(ins)) {
       	   ...
       	   INSTRUMENT_PREDICATED(
       	     INSTR_IF_DETAILED(inst_mode),
       	     trace, ins, IPOINT_TAKEN_BRANCH, (AFUNPTR)handleRetIndirect, 
       	     IARG_THREAD_ID,
       	     IARG_BRANCH_TARGET_ADDR,
       	     IARG_END);
       	 }
       	 ...
       	 if (INS_IsDirectBranchOrCall(ins)) {
       	   INSTRUMENT_PREDICATED(
       	     INSTR_IF_DETAILED(inst_mode),
       	     trace, ins, IPOINT_TAKEN_BRANCH, (AFUNPTR)handleJumpDirect, 
       	     IARG_THREAD_ID,
       	     IARG_BRANCH_TARGET_ADDR,
       	     IARG_END);
       	 } else {
       	   INSTRUMENT_PREDICATED(
       	     INSTR_IF_DETAILED(inst_mode),
       	     trace, ins, IPOINT_TAKEN_BRANCH, (AFUNPTR)handleJumpIndirect, 
       	     IARG_THREAD_ID,
       	     IARG_BRANCH_TARGET_ADDR,
       	     IARG_END);	   
       	 }
